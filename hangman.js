let animals = [
    ...
    'Kangaroo', 'Panda', 'Koala', 'Leopard', 'Cheetah',
    'Hippo', 'Rhinoceros', 'Crocodile', 'Alligator', 'Penguin',
    'Ostrich', 'Flamingo', 'Peacock', 'Eagle', 'Hawk',
    'Shark', 'Dolphin', 'Whale', 'Octopus', 'Squid',
    'Lobster', 'Crab', 'Jellyfish', 'Starfish', 'Turtle',
    'Frog', 'Toad', 'Snake', 'Lizard', 'Chameleon',
    'Parrot', 'Macaw', 'Toucan', 'Bat', 'Owl',
    'Wolf', 'Fox', 'Bear', 'Deer', 'Moose',
    'Buffalo', 'Bison', 'Antelope', 'Gazelle', 'Camel',
    'Sheep', 'Goat', 'Cow', 'Pig', 'Horse',
    'Chicken', 'Rooster', 'Duck', 'Goose', 'Turkey',
    'Dog', 'Cat', 'Rabbit', 'Hamster', 'Guinea Pig',
    'Mouse', 'Rat', 'Squirrel', 'Hedgehog', 'Chinchilla',
    'Ferret', 'Skunk', 'Raccoon', 'Porcupine', 'Beaver',
    'Otter', 'Seal', 'Walrus', 'Polar Bear', 'Penguin'
];
